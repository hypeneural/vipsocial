...
import { SLIDESHOW_PANEL, SLIDESHOW_SAFE_AREA } from "../design/tokens";
...
export function IdleScreen({
    ...
    return (
        <div className={cn("flex min-h-screen items-center justify-center", SLIDESHOW_SAFE_AREA)}>
            <div className={cn("grid w-full max-w-6xl gap-8 p-8 lg:grid-cols-[1.05fr_0.95fr] lg:p-12", SLIDESHOW_PANEL)}>
                <div className="space-y-6">
                    ...
                    <div className="space-y-4">
                        <p className="text-sm uppercase tracking-[0.35em] text-white/55">Cobertura VIP</p>
                        ...
                        <p className="max-w-2xl text-[clamp(1rem,1.4vw,1.35rem)] leading-relaxed text-white/70">
                            {instructions || "O envio neste primeiro momento e interno. Assim que uma foto for aprovada, ela entra automaticamente no slideshow."}
                        </p>
                    </div>
                </div>
                        ...
                        <div className="rounded-[24px] border border-neutral-200 bg-[linear-gradient(135deg,_#fff7ed_0%,_#ffffff_48%,_#eff6ff_100%)] p-8">
                            <div className="grid gap-4 sm:grid-cols-[auto_1fr] sm:items-center">
                                ...
                                <div className="space-y-2 text-center sm:text-left">
                                    <p className="text-xs uppercase tracking-[0.35em] text-neutral-500">Codigo do telao</p>
                                    <p className="font-mono text-[clamp(1.4rem,3vw,2.2rem)] font-semibold tracking-[0.22em] text-neutral-950">
                                        {code}
                                    </p>
                                    <p className="text-sm leading-relaxed text-neutral-600">
                                        O player fica em espera ate a proxima foto interna ser aprovada para exibicao.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="mt-6 grid gap-3 sm:grid-cols-2">
                                <div className="rounded-2xl bg-neutral-950 px-4 py-4 text-white">
                                    <p className="text-xs uppercase tracking-[0.3em] text-white/55">Operacao</p>
                                    <p className="mt-2 text-base font-semibold">Fila local e cache ativos</p>
                                </div>
                                <div className="rounded-2xl border border-neutral-200 bg-white px-4 py-4">
                                    <div className="flex items-center gap-2 text-neutral-700">
                                        <Users className="h-4 w-4" />
                                        <p className="text-xs uppercase tracking-[0.3em]">Envio interno</p>
                                    </div>
                                    <p className="mt-2 text-sm leading-relaxed text-neutral-600">
                                        Sem QR nesta fase. O telão aguarda novas fotos do grupo interno do evento.
                                    </p>
                                </div>
                            </div>
                        </div>
